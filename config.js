...
module.exports = {
  ...
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ᴍᴀᴅᴇ ʙʏ;ᴀʟᴀɴ ᴡᴀʟᴋᴇʀ',
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ᴊᴀʀᴠɪꜱ-ᴍᴅ',
  MENU_FONT: process.env.MENU_FONT || "0;0",
  SUDO: process.env.SUDO || '923278974102',
